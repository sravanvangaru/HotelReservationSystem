	...
	<nav style="background-color: rgba(0, 0, 0, 0.1);"
		...
		<div class="container-fluid">
			<div class="navbar-header">
				<center><a class = "navbar-brand" ><h2>Hotel Reservation System</h2></a></center>
			</div>
		</div>
	</nav>
	<!-- ========================= SECTION CONTENT ========================= -->
				...
				<div class="panel-body">
					...
					<div class="col-lg-6" >
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<form  id="reservationForm" name="form" method="post" action="MakeReservation" onsubmit="return validInsert();">
									<div class="form-group" >
										<label>Firstname</label> <input type="text" minlength="3" maxlength="25" onkeypress="return (event.charCode > 64 && 
	event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" 
											class="form-control" name="firstname" required="required" />
									</div>
									<div class="form-group">
										<label>Middlename</label> <input type="text" minlength="3" maxlength="25" onkeypress="return (event.charCode > 64 && 
	event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" 
											class="form-control" name="middlename"  />
									</div>
									<div class="form-group">
										<label>Lastname</label> <input type="text" minlength="3" maxlength="25" onkeypress="return (event.charCode > 64 && 
	event.charCode < 91) || (event.charCode > 96 && event.charCode < 123)" 
											class="form-control" name="lastname" required="required" />
									</div>
									<div class="form-group">
										<label>Address</label> <input type="text" minlength="5" maxlength="20" class="form-control"
											name="address" required="required" />
									</div>
									<div class="form-group">
										<label>Contact No</label> <input type="text"  
											class="form-control" name="contactno" required="required"  onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" maxlength="11" />
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label>Stay Days</label> <input type="text"
											class="form-control" name="day" required="required" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" maxlength="3" //>
									</div>
									<div class="form-group">
										<label>Email Id</label> <input type="text"
											class="form-control" name="recipient" required="required" />
									</div>
									<div class="form-group">
										<label for="mode" >Payment Mode</label> 
										<select name="mode" id="pay" required>
                                        <option value="" disabled selected>Choose your Payment Mode</option>
      									<option  value="online">Online</option>
      									<option  value="offline">Payment at desk</option>
    									</select>
									</div>
									<br />
									<div class="form-group">
